...
def load_model():
    ...
    # st.write("Model weights after loading:", model.get_weights())
...
if canvas_result.json_data is not None:
    ...
    if processed_data is not None:
        ...
        # reconstructed_vae = vae.predict(scaled_processed_data)
        ...
        print(ae_preds)
        # vae_preds = tf.math.less(tf.keras.losses.mse(reconstructed_vae, processed_data), vae_threshold)
        # print(vae_preds)
        ...
        st.write("BIGAN Loss:", tf.keras.losses.binary_crossentropy(reconstructed_bigan, processed_data))
